...
GfxDevice::GfxDevice(Window &window) : m_window{window} {
  createInstance();
  setupDebugMessenger();
  createSurface();
  pickPhysicalDevice();
...
GfxDevice::querySwapChainSupport(VkPhysicalDevice device) {
...
VkFormat GfxDevice::findSupportedFormat(const std::vector<VkFormat> &candidates,
...
uint32_t GfxDevice::findMemoryType(uint32_t typeFilter,
...
void GfxDevice::createBuffer(VkDeviceSize size, VkBufferUsageFlags usage,
...
void GfxDevice::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer,
                           VkDeviceSize size) {
...
void GfxDevice::copyBufferToImage(VkBuffer buffer, VkImage image,
...
void GfxDevice::createImageWithInfo(const VkImageCreateInfo &imageInfo,
                                    VkMemoryPropertyFlags properties,
                                    VkImage &image,
