...
VkResult GfxSwapChain::acquireNextImage(uint32_t *imageIndex) {
...
VkResult GfxSwapChain::submitCommandBuffers(const VkCommandBuffer *buffers,
                                            uint32_t *imageIndex) {
  if (m_imagesInFlight[*imageIndex] != VK_NULL_HANDLE) {
    vkWaitForFences(m_device.device(), 1, &m_imagesInFlight[*imageIndex],
                    VK_TRUE, UINT64_MAX);
  }
...
VkSurfaceFormatKHR GfxSwapChain::chooseSwapSurfaceFormat(
...
VkPresentModeKHR GfxSwapChain::chooseSwapPresentMode(
...
VkExtent2D
GfxSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
...
VkFormat GfxSwapChain::findDepthFormat() {
